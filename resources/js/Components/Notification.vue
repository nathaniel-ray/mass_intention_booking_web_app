<template>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                >
                    <button
                        data-modal-hide="default-modal"
                        type="button"
                        class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:red-blue-800"
                    >
                        Log Out
                    </button>
                    <button
    ...
    <nav class="flex justify-between p-4">
        <p class="font-semibold text-2xl pb-4">Admin Settings</p>
